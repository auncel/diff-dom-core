...
type TCSSShorthandProperties = keyof typeof CSSShorthandProperties;
 ...
 * @param text CSS 字符串
 */
export function parseCSS(text: string): Map<string, Set<string>> {
    ...
    if (node.type === 'Rule') {
      ...
      block.children.forEach((declaration) => {
        if (declaration.type === 'Declaration') {
          if (CSSShorthandProperties[declaration.property as TCSSShorthandProperties]) {
            CSSShorthandProperties[declaration.property as TCSSShorthandProperties]
